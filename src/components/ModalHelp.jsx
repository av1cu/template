  ...
  return (
    ...
    >
      <Box sx={style}>
        ...
        <Typography sx={{ fontWeight: 'bold' }}>5. Загрузка, скачивание и удаление файлов:</Typography>
        <Typography sx={{ mt: 1 }}>
          Для каждого вагона можно прикрепить файлы, связанные с его ремонтом. Вот как это работает:
        </Typography>
        <ul>
          <li><strong>Загрузить файл:</strong> чтобы прикрепить файл к вагону, нажмите на кнопку "Загрузить файл". Это откроет окно выбора файла на вашем устройстве.</li>
          <li><strong>Скачать файл:</strong> чтобы скачать прикрепленный файл, просто нажмите кнопку "Скачать файл". Файл будет загружен на ваше устройство.</li>
          <li><strong>Удалить файл:</strong> если файл больше не нужен, можно удалить его, нажав на кнопку "Удалить файл". Будьте осторожны, это действие необратимо!</li>
        </ul>
